...
public class AutoLinkTest extends Activity{
	...
	{
//        String htmlLinkText =  "<a href=http://www.baidu.com>百度</a><a href=http://www.wangyi.com>网易</a>";//"我是超链接"+ "<a style=\"color:red;\" href='lianjie'>超链接点击事件</a>";  
        String htmlLinkText = "我已看过并同意< <a href=http://www.baidu.com>慧聪网服务条款</a>>和< <a href=http://www.google.com>慧聪网在线交易服务条款</a>>";
...
//                Toast.makeText(AutoLinkTest.ctx, mUrl, Toast.LENGTH_LONG).show();  
